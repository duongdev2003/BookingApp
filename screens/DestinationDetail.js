            ...
            <View style={{flex: 1.5}}>
                ...
                <View style={{marginTop: SIZES.padding, paddingHorizontal: SIZES.padding}}>
                    ...
                    <Text style={{marginTop: SIZES.radius, color: COLORS.gray, ...FONTS.body3}}>
                        ...
                        the world and is known as the best place to ski. Many other facilities, such as fitness center,
                        sauna, steam room to star-rated restaurants.
                    </Text>
                </View>
            </View>
                ...
                <LinearGradient
                    ...
                    <View style={{flex: 1, flexDirection: 'row', alignItems: 'center'}}>
                        <View style={{flex: 1, marginHorizontal: SIZES.padding, justifyContent: 'center'}}>
                            <Text style={{...FONTS.h1}}>$10.000</Text>
                        </View>
